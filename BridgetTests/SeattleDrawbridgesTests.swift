...
final class SeattleDrawbridgesTests: XCTestCase {
  ...
  func testCanonicalBridgeIDValidation() {
    ...
    XCTAssertTrue(SeattleDrawbridges.isCanonicalBridgeID("1"), "First Avenue South Bridge should be canonical")
    XCTAssertTrue(SeattleDrawbridges.isCanonicalBridgeID("2"), "Ballard Bridge should be canonical")
    XCTAssertTrue(SeattleDrawbridges.isCanonicalBridgeID("29"), "South Park Bridge should be canonical")

    // Test non-canonical bridge IDs
    XCTAssertFalse(SeattleDrawbridges.isCanonicalBridgeID("0"), "Non-existent bridge ID should not be canonical")
    XCTAssertFalse(SeattleDrawbridges.isCanonicalBridgeID("999"),
                   "Non-existent bridge ID should not be canonical")
    XCTAssertFalse(SeattleDrawbridges.isCanonicalBridgeID("bridge1"), "Synthetic test ID should not be canonical")
    XCTAssertFalse(SeattleDrawbridges.isCanonicalBridgeID(""), "Empty string should not be canonical")
  }

  func testSyntheticTestBridgeIDValidation() {
    // Test synthetic test bridge IDs
    XCTAssertTrue(SeattleDrawbridges.isSyntheticTestBridgeID("bridge1"), "bridge1 should be synthetic test ID")
    XCTAssertTrue(SeattleDrawbridges.isSyntheticTestBridgeID("bridge2"), "bridge2 should be synthetic test ID")
    ...
    XCTAssertFalse(SeattleDrawbridges.isSyntheticTestBridgeID("1"), "Canonical bridge ID should not be synthetic")
    XCTAssertFalse(SeattleDrawbridges.isSyntheticTestBridgeID("bridge"),
                   "bridge without number should not be synthetic")
    XCTAssertFalse(SeattleDrawbridges.isSyntheticTestBridgeID("bridge1a"), "bridge1a should not be synthetic")
    XCTAssertFalse(SeattleDrawbridges.isSyntheticTestBridgeID(""), "Empty string should not be synthetic")
  }

  func testAcceptedBridgeIDValidation() {
    // Test with allowSynthetic: false (default)
    XCTAssertTrue(SeattleDrawbridges.isAcceptedBridgeID("1"), "Canonical bridge ID should be accepted")
    XCTAssertTrue(SeattleDrawbridges.isAcceptedBridgeID("29"), "Canonical bridge ID should be accepted")
    XCTAssertFalse(SeattleDrawbridges.isAcceptedBridgeID("bridge1"),
                   "Synthetic test ID should not be accepted by default")
    XCTAssertFalse(SeattleDrawbridges.isAcceptedBridgeID("999"), "Non-canonical ID should not be accepted")
    ...
    XCTAssertTrue(SeattleDrawbridges.isAcceptedBridgeID("bridge1", allowSynthetic: true),
                  "Synthetic test ID should be accepted when allowed")
    XCTAssertTrue(SeattleDrawbridges.isAcceptedBridgeID("bridge999", allowSynthetic: true),
                  "Synthetic test ID should be accepted when allowed")
