...
struct CoordinateTransformationMonitoringTests {
  ...
  func testRecordSuccessfulTransformation() throws {
    ...
    let timeRange = TimeRange(startDate: Date().addingTimeInterval(-60 * 60),
                              endDate: Date().addingTimeInterval(60))

    monitoringService.recordSuccessfulTransformation(bridgeId: bridgeId,
  ...
  func testRecordFailedTransformation() throws {
    ...
    monitoringService.recordFailedTransformation(bridgeId: bridgeId,
                                                 sourceSystem: "SeattleAPI",
                                                 targetSystem: "SeattleReference",
  ...
  func bridgeSpecificMetrics() throws {
    ...
    let bridgeMetrics = monitoringService.getBridgeMetrics(bridgeId: bridgeId,
                                                           timeRange: timeRange)
  ...
  func testLowSuccessRateAlert() throws {
    ...
    let alertConfig = AlertConfig(minimumSuccessRate: 0.9,
  ...
  func testHighProcessingTimeAlert() throws {
    // Configure alert threshold
    let alertConfig = AlertConfig(minimumSuccessRate: 0.5,
    ...
    for i in 0 ..< 5 {
      monitoringService.recordSuccessfulTransformation(bridgeId: "bridge-\(i)",
                                                       sourceSystem: "SeattleAPI",
                                                       targetSystem: "SeattleReference",
                                                       confidence: 0.95,
  ...
  func alertCooldown() throws {
    ...
    monitoringService.recordFailedTransformation(bridgeId: "test-bridge",
                                                 sourceSystem: "SeattleAPI",
                                                 targetSystem: "SeattleReference",
                                                 errorMessage: "Test failure",
                                                 processingTimeMs: 2.0,
  ...
  func testExportMonitoringData() throws {
    ...
    // Record some events
    monitoringService.recordSuccessfulTransformation(bridgeId: "export-test-bridge",
                                                     sourceSystem: "SeattleAPI",
                                                     targetSystem: "SeattleReference",
                                                     confidence: 0.95,
                                                     processingTimeMs: 5.0,
  ...
  func testClearOldEvents() throws {
    ...
    // Record events
    monitoringService.recordSuccessfulTransformation(bridgeId: "old-bridge",
                                                     sourceSystem: "SeattleAPI",
                                                     targetSystem: "SeattleReference",
                                                     confidence: 0.95,
                                                     processingTimeMs: 5.0,
  ...
  func testGetRecentAlerts() throws {
    ...
    for i in 0 ..< 5 {
      monitoringService.recordFailedTransformation(bridgeId: "alert-bridge-\(i)",
                                                   sourceSystem: "SeattleAPI",
                                                   targetSystem: "SeattleReference",
                                                   errorMessage: "Test failure",
                                                   processingTimeMs: 2.0,
