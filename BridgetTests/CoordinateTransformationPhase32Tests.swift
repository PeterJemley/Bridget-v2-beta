...
struct CoordinateTransformationPhase32Tests {
  ...
  func transformationAccuracy() throws {
    ...
    let testCases:
      [(bridgeId: String, apiCoords: (lat: Double, lon: Double),
        ...
        ("1", (47.542213439941406, -122.33446502685547),
         (47.598, -122.332)),  // Bridge 1
        ("6", (47.57137680053711, -122.35354614257812),
         (47.58, -122.35)),  // Bridge 6
      ]

    for testCase in testCases {
      let result = transformService.transformToReferenceSystem(latitude: testCase.apiCoords.lat,
      ...
      // Calculate distances
      let originalDistance = haversineDistanceMeters(lat1: testCase.apiCoords.lat,
                                                     lon1: testCase.apiCoords.lon,
                                                     lat2: testCase.expectedCoords.lat,
                                                     lon2: testCase.expectedCoords.lon)

      let transformedDistance = haversineDistanceMeters(lat1: transformedLat,
                                                        lon1: transformedLon,
                                                        lat2: testCase.expectedCoords.lat,
                                                        lon2: testCase.expectedCoords.lon)
      ...
      #expect(transformedDistance < 1000,
  ...
  func endToEndValidationPipeline() throws {
    ...
    let bridgeRecordValidator = BridgeRecordValidator(knownBridgeIDs: knownBridgeIDs,
