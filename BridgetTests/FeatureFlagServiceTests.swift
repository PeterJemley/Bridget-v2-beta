...
@Suite struct FeatureFlagServiceTests {
  ...
  func testFeatureFlagEnabled() throws {
    let service = DefaultFeatureFlagService()
    ...
    try service.updateConfig(FeatureFlagConfig(
  ...
  func testGradualRollout() throws {
    let service = DefaultFeatureFlagService()
  ...
  func testABTestingDistribution() throws {
    let service = DefaultFeatureFlagService()
  ...
  func testPersistence() throws {
    ...
    try service1.updateConfig(FeatureFlagConfig(
      flag: .coordinateTransformation,
      enabled: true,
      rolloutPercentage: .fiftyPercent,
