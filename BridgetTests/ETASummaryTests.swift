...
struct ETASummaryTests {
    ...
    func eTASummaryFromSingleValue() {
    ...
    func eTASummaryFromMultipleValues() {
    ...
    func eTASummaryPercentilesInsufficientData() {
    ...
    func arrayBasicStatisticsSingleValue() {
        let values = [42.0]
        let stats = values.basicStatistics()
    ...
    func arrayBasicStatisticsEmpty() {
        let values: [Double] = []
        let stats = values.basicStatistics()
    ...
    func confidenceIntervalZeroVariance() {
