...
struct PipelineMetricsModelsTests {
    ...
    func testPipelineStageMetricInitialization() throws {
    ...
    func testDisplayNameMapping() throws {
        let testCases = [
    ...
    func testStatusColorLogic() throws {
        // Test error state (red)
        let errorMetric = PipelineStageMetric(
            stage: "test",
            duration: 1.0,
            memory: 100,
            errorCount: 1,
        ...
        let warningMetric = PipelineStageMetric(
            stage: "test",
            duration: 1.0,
            memory: 100,
            errorCount: 0,
        ...
        let successMetric = PipelineStageMetric(
            stage: "test",
            duration: 1.0,
            memory: 100,
            errorCount: 0,
    ...
    func testEqualityAndHashing() throws {
        let metric1 = PipelineStageMetric(
            stage: "dataLoading",
            duration: 2.5,
            memory: 128,
            errorCount: 0,
        ...
        let metric2 = PipelineStageMetric(
            stage: "dataLoading",
            duration: 2.5,
            memory: 128,
            errorCount: 0,
        ...
        let metric3 = PipelineStageMetric(
    ...
    func testPipelineMetricsDataInitialization() throws {
    ...
    func testStageMetricsComputedProperty() throws {
        let data = PipelineMetricsData(
            timestamp: Date(),
            stageDurations: [
                "dataLoading": 2.5,
    ...
    func testComputedTotals() throws {
        let data = PipelineMetricsData(
            timestamp: Date(),
    ...
    func testAverageValidationRateEdgeCases() throws {
        // Empty validation rates should return 1.0
        let emptyData = PipelineMetricsData(
            timestamp: Date(),
            stageDurations: [:],
            memoryUsage: [:],
            validationRates: [:],
        ...
        let singleData = PipelineMetricsData(
            timestamp: Date(),
    ...
    func testCodableConformance() throws {
        let originalData = PipelineMetricsData(
            timestamp: Date(),
