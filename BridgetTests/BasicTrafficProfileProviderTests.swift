...
final class BasicTrafficProfileProviderTests: XCTestCase {
    ...
    func testCreateCustomProfile() throws {
        let customProfile = provider.createProfile(
            name: "Test Profile",
    ...
    func testGetTrafficMultiplierMorningRush() throws {
        ...
        let multiplier = provider.getTrafficMultiplier(
            for: morningDate,
    ...
    func testTimePeriodFromDate() throws {
        XCTAssertEqual(
            TimePeriod.fromDate(createDate(hour: 7, minute: 30)),
            .morningRush
        )
        XCTAssertEqual(
            TimePeriod.fromDate(createDate(hour: 8, minute: 59)),
            .morningRush
        )
        XCTAssertEqual(
            TimePeriod.fromDate(createDate(hour: 9, minute: 0)),
            .midday
        )
        XCTAssertEqual(
            TimePeriod.fromDate(createDate(hour: 15, minute: 59)),
            .midday
        )
        XCTAssertEqual(
            TimePeriod.fromDate(createDate(hour: 16, minute: 0)),
            .eveningRush
        )
        XCTAssertEqual(
        ...
        XCTAssertEqual(
            TimePeriod.fromDate(createDate(hour: 19, minute: 0)),
            .night
        )
        XCTAssertEqual(
            TimePeriod.fromDate(createDate(hour: 6, minute: 59)),
            .night
        )
    }
    ...
    func testUpdateProfile() throws {
        ...
        XCTAssertNotEqual(
            updatedProfile?.morningRushMultiplier,
            originalMultiplier
        )
    }
    ...
    func testProfileTotalMultiplier() throws {
        ...
        let totalMultiplier = profile.getTotalMultiplier(
            for: date,
            segmentType: .arterial
        )
