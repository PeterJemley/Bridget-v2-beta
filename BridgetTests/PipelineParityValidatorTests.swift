...
struct PipelineParityValidatorTests {
  ...
  private func createBaselineMetrics() -> BaselineMetrics {
    ...
    let schema = DataSchema(
      fields: ["v", "ts_utc", "bridge_id", "cross_k", "cross_n", "via_routable", "via_penalty_sec", "gate_anom", "alternates_total", "alternates_avoid_span", "free_eta_sec", "via_eta_sec", "open_label"],
      fieldTypes: [
  ...
  mutating func testParityPassesWhenNoCodeChanged() async throws {
    try await setUp()
  ...
  mutating func testShapeDriftRemovesOneFeatureExpectsCriticalChange() async throws {
    try await setUp()
    ...
    currentOutput = CurrentOutput(
      ...
      schema: DataSchema(
        fields: ["v", "ts_utc", "bridge_id", "cross_k", "cross_n", "via_routable", "via_penalty_sec", "gate_anom", "alternates_total", "alternates_avoid_span", "free_eta_sec", "open_label"], // Missing "via_eta_sec"
        fieldTypes: [
          "v": "Int", "ts_utc": "String", "bridge_id": "Int", "cross_k": "Int16", "cross_n": "Int16",
          "via_routable": "Int", "via_penalty_sec": "Int32", "gate_anom": "Double", "alternates_total": "Int16",
  ...
  mutating func testCountDriftDrops2PercentOfTicksForOneBridgeExpectsWarningCountChange() async throws {
    try await setUp()
  ...
  mutating func testRangeDriftScalesOneFeatureBy10PercentExpectsWarningOnValueRange() async throws {
    try await setUp()
  ...
  mutating func testSchemaDriftRenamesFieldExpectsCriticalWithSchemaDiffDetails() async throws {
    try await setUp()
  ...
  mutating func testPerformanceDriftInjects20PercentSlowdownExpectsWarningBasedOnConfig() async throws {
    try await setUp()
  ...
  mutating func testRelaxedConfigurationAllowsSmallerChanges() async throws {
    try await setUp()
  ...
  mutating func testNaNInfValuesTriggerAutomaticCriticalInRangeValidation() async throws {
    try await setUp()
  ...
  mutating func testZeroBaselineAndCurrentDefineRelativeDeltaAsZero() async throws {
    try await setUp()
  ...
  mutating func testModuleImpactAnalysisIdentifiesCorrectModule() async throws {
    try await setUp()
  ...
  mutating func testParityGateFacadeRunsValidation() async throws {
    try await setUp()
