...
struct PipelineParityValidatorTests {
  ...
  private func createBaselineMetrics() -> BaselineMetrics {
    ...
    let fieldRanges: [String: ValueRange] = [
      ...
      "via_penalty_sec": ValueRange(
        min: 0, max: 300, mean: 45.8, description: "Baseline penalty range"),
      "gate_anom": ValueRange(min: 0, max: 1, mean: 0.5, description: "Baseline anomaly range"),
      "alternates_total": ValueRange(
        min: 1, max: 5, mean: 3.2, description: "Baseline alternates range"),
    ]
    ...
    let schema = DataSchema(
      fields: [
        "v", "ts_utc", "bridge_id", "cross_k", "cross_n", "via_routable", "via_penalty_sec",
        "gate_anom", "alternates_total", "alternates_avoid_span", "free_eta_sec", "via_eta_sec",
        "open_label",
      ],
      fieldTypes: [
        "v": "Int", "ts_utc": "String", "bridge_id": "Int", "cross_k": "Int16", "cross_n": "Int16",
        "via_routable": "Int", "via_penalty_sec": "Int32", "gate_anom": "Double",
        "alternates_total": "Int16",
        "alternates_avoid_span": "Int16", "free_eta_sec": "Int32?", "via_eta_sec": "Int32?",
        "open_label": "Int",
      ])
  ...
  mutating func shapeDriftRemovesOneFeatureExpectsCriticalChange() async throws {
    ...
    currentOutput = CurrentOutput(
      ...
      schema: DataSchema(
        fields: [
          "v", "ts_utc", "bridge_id", "cross_k", "cross_n", "via_routable", "via_penalty_sec",
          "gate_anom", "alternates_total", "alternates_avoid_span", "free_eta_sec", "open_label",
        ],  // Missing "via_eta_sec"
        fieldTypes: [
          "v": "Int", "ts_utc": "String", "bridge_id": "Int", "cross_k": "Int16",
          "cross_n": "Int16",
          "via_routable": "Int", "via_penalty_sec": "Int32", "gate_anom": "Double",
          "alternates_total": "Int16",
    ...
    #expect(
      result.affectedModule == .bridgeDataProcessor, "BridgeDataProcessor should be identified")
  ...
  mutating func rangeDriftScalesOneFeatureBy10PercentExpectsWarningOnValueRange() async throws {
    ...
    let scaledFieldRanges: [String: ValueRange] = [
      ...
      "via_penalty_sec": ValueRange(
        min: 0, max: 300, mean: 45.8, description: "Current penalty range"),
      "gate_anom": ValueRange(min: 0, max: 1, mean: 0.5, description: "Current anomaly range"),
      "alternates_total": ValueRange(
        min: 1, max: 5, mean: 3.2, description: "Current alternates range"),
    ]
  ...
  mutating func performanceDriftInjects30PercentSlowdownExpectsWarningBasedOnConfig() async throws {
    ...
    #expect(
      result.isParity == false, "Parity should fail when performance differs beyond tolerance")
  ...
  mutating func naNInfValuesTriggerAutomaticCriticalInRangeValidation() async throws {
    ...
    let nanFieldRanges: [String: ValueRange] = [
      "cross_k": ValueRange(
        min: Double.nan, max: 100, mean: 45.2, description: "NaN cross_k range"),
      "cross_n": ValueRange(min: 1, max: 200, mean: 98.7, description: "Current cross_n range"),
      "via_penalty_sec": ValueRange(
        min: 0, max: 300, mean: 45.8, description: "Current penalty range"),
      "gate_anom": ValueRange(min: 0, max: 1, mean: 0.5, description: "Current anomaly range"),
  ...
  mutating func parityGateFacadeRunsValidation() async throws {
    ...
    let baselineURL = FileManagerUtils.temporaryDirectory().appendingPathComponent(
      "test_baseline.json")
