...
struct FeatureEngineeringGoldenTests {
    ...
    func testGoldenSampleFeatures() async throws {
        let horizons = [0, 3]
    ...
    func testSingleTickSingleBridgeAllHorizons() async throws {
    ...
    func testDSTBoundary() async throws {
        let tick = ProbeTickRaw(
          v: 1,
...
struct FeatureEngineeringHelperTests {
    ...
    func testMinuteOfDayAndDayOfWeek() async throws {
