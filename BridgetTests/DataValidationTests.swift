...
struct DataValidationTests {
  ...
  mutating func testGoldenSampleProbeTicksValidation() async throws {
  ...
  mutating func testGoldenSampleFeatureVectorsValidation() async throws {
    // Create fresh validation service and data for this test
    let testValidationService = DataValidationService()
  ...
  mutating func testEmptyArraysValidation() async throws {
    try await setUp()
  ...
  mutating func testSingleRecordValidation() async throws {
    try await setUp()
    let singleTick = [ProbeTickRaw(
      v: 1,
  ...
  mutating func testDSTBoundaryTimestamps() async throws {
    try await setUp()
  ...
  mutating func testInvalidBridgeIDs() async throws {
    try await setUp()
  ...
  mutating func testNaNValuesDetection() async throws {
    try await setUp()
    guard !goldenSampleTicks.isEmpty else { return }
  ...
  mutating func testInfiniteValuesDetection() async throws {
    try await setUp()
    guard !goldenSampleTicks.isEmpty else { return }
  ...
  mutating func testNonMonotonicTimestamps() async throws {
    try await setUp()
  ...
  mutating func testFeatureVectorCyclicalRangeValidation() async throws {
    try await setUp()
  ...
  mutating func testFeatureVectorInvalidTargets() async throws {
    try await setUp()
    guard !goldenSampleFeatures.isEmpty else { return }
    var invalidFeatures = goldenSampleFeatures
    invalidFeatures[0] = FeatureVector(
  ...
  mutating func testFeatureVectorHorizonCoverage() async throws {
    try await setUp()
  ...
  mutating func testDataQualityMetricsAggregation() async throws {
    try await setUp()
  ...
  mutating func testValidationRateCalculation() async throws {
    try await setUp()
    let result = validationService.validate(ticks: goldenSampleTicks)
