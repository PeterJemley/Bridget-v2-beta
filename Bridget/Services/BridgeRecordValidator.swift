...
struct BridgeRecordValidator {
    ...
    init(knownBridgeIDs: Set<String>, bridgeLocations: [String:(lat: Double, lon: Double)], validEntityTypes: Set<String>, minDate: Date, maxDate: Date) {
    ...
    func validationFailure(for record: BridgeOpeningRecord) -> ValidationFailureReason? {
