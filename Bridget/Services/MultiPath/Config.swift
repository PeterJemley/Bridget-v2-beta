...
public struct MultiPathConfig: Codable, Sendable {
...
public struct PathEnumConfig: Codable, Sendable {
...
public enum PathEnumerationMode: String, Codable, CaseIterable, Sendable {
  case dfs
  case yensKShortest = "yens_k_shortest"
  case auto
}

public struct ClampBounds: Codable, Sendable {
...
public enum LogVerbosity: String, Codable, CaseIterable, Sendable {
  case silent
  case warnings
  case verbose
}

public struct MultiPathPerformanceConfig: Codable, Sendable {
...
public enum PredictionMode: String, Codable, CaseIterable, Sendable {
  case baseline
...
public extension MultiPathConfig {
  ...
  // Return a fresh instance each time to avoid any perception of shared mutable state across tasks.
  static var testing: MultiPathConfig {
    MultiPathConfig(pathEnumeration: PathEnumConfig(maxPaths: 10,
                                                    maxDepth: 5,
                                                    maxTravelTime: 600,
                                                    randomSeed: 42,
