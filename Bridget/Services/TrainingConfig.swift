...
public extension TrainingConfig {
  ...
  struct PerformanceBudget: Sendable {
    ...
    /// Default production performance budget (immutable and concurrency-safe)
    ...
    /// Relaxed development performance budget (immutable and concurrency-safe)
