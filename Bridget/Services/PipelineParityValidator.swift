...
public class PipelineParityValidator {
    ...
    public func validateParity(
        ...
        let shapeChanges = validateShapeParity(
            baseline: baseline,
            current: current
        )
    ...
    private func validatePerformanceParity(
        ...
        if !baseline.pipelineTime.isWithin(
        ...
        if !baseline.peakMemory.isWithin(
    ...
    private func compareFieldDistributions(
        ...
        return DistributionChange(
            isSignificant: pValue < 0.05 || !missingKeys.isEmpty
                || !newKeys.isEmpty,
            chiSquare: chiSquare,
            pValue: pValue,
