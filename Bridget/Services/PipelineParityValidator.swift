...
struct ParityConfig: Codable {
  ...
  static let `default` = ParityConfig(
    shapeStrict: true,
  ...
  static let relaxed = ParityConfig(
    shapeStrict: false,
...
class PipelineParityValidator {
  ...
  private func validateRangeParity(baseline: BaselineMetrics, current: CurrentOutput, sample: GoldenSample) -> [OutputChange] {
    var changes: [OutputChange] = []
