...
// MARK: - Adopt TrainingConfig's PerformanceBudget

// Use a single source of truth for the performance budget type to avoid duplication
public typealias PerformanceBudget = TrainingConfig.PerformanceBudget
...
public struct BudgetValidationResult: Sendable {
...
public func createPerformanceMonitor(budget: PerformanceBudget = .production)
