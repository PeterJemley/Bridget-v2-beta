...
final class TrafficProfileManagementViewModel {
  ...
  func createProfile(name: String, description: String) {
    _ = provider.createProfile(name: name,
      ...
      List {
        ...
        Section("All Profiles") {
          ForEach(viewModel.profiles) { profile in
            TrafficProfileRowView(profile: profile,
                                  isActive: profile.id
...
#Preview {
  ...
  let container = try! ModelContainer(for: TrafficProfile.self,
