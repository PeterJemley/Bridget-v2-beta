  ...
  var body: some View {
    VStack(alignment: .leading, spacing: 12) {
      ...
      VStack(alignment: .leading, spacing: 8) {
        StatusRow(title: "Data Population",
                  status: getPopulationStatus(),
                  icon: "calendar.badge.plus")

        StatusRow(title: "Data Export",
                  status: getExportStatus(),
                  icon: "square.and.arrow.up")

        StatusRow(title: "Auto-Export",
  ...
  var body: some View {
    ZStack {
      ...
      VStack(spacing: 12) {
        ...
        HStack(spacing: 16) {
          QuickActionButton(title: "Populate Today",
                            icon: "calendar.badge.plus",
                            action: populateTodayData)

          QuickActionButton(title: "Export Today",
                            icon: "square.and.arrow.up",
  ...
  private func exportTodayData() {
    Task {
      do {
        ...
        await MainActor.run {
          // Show success notification
          MLPipelineNotificationManager.shared.showSuccessNotification(title: "Export Complete",
...
struct RecentActivityView: View {
  var body: some View {
    VStack(alignment: .leading, spacing: 12) {
      ...
      VStack(alignment: .leading, spacing: 8) {
        ActivityRow(title: "Data Population",
                    description: "Today's data populated successfully",
                    time: "2 hours ago",
                    status: .success)

        ActivityRow(title: "Data Export",
